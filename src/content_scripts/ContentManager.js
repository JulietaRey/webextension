class ContentManager {
  ...
  showResultsInSearch({ results: { own, external } }) {
    this.results = { own: this.transformData(own), external: external.map(this.transformData) };
    this.contentEngine.addResults(this.results.external);
  }
  ...
  injectMashupButton() {
    ...
    document.querySelector(this.contentEngine.getMenuSelector()).appendChild(buttonContainer);
  }
